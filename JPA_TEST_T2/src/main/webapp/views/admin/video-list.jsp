...
<div class="container mt-5">
	...
	<div class="d-flex justify-content-between mb-4">
		<a href="${pageContext.request.contextPath}/admin/video/add"
			class="btn btn-primary">Add Video</a> <a
			href="${pageContext.request.contextPath}/admin/categories"
			class="btn btn-secondary">Category List</a>
	</div>
			...
			<c:forEach var="video" items="${videoList}">
				<tr>
					...
					<td class="text-center" style="width: 300px; height: 200px;">
						...
						</c:if> <img src="${imgUrl}" class="img-thumbnail mb-2"
						style="width: 200px; height: 150px;" alt="Video Poster">
					</td>
					<td>${video.views}</td>
					<td><span
						class="badge ${video.active == 1 ? 'bg-success' : 'bg-danger'}">
							${video.active == 1 ? 'Active' : 'Inactive'} </span></td>
					<td><a
